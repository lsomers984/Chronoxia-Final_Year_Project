...
INTRO = ("==========================\n"
         "Chronoxia Discord Bot - Launcher\n"
         "==========================\n")
...
def parse_cli_arguments():
    parser = argparse.ArgumentParser(description="Chronoxia - Discord Bot's launcher")
    parser.add_argument("--start", "-s",
                        help="Starts Chronoxia",
                        action="store_true")
...
def update_menu():
    ...
    while True:
        ...
        print("Update:\n")
        print("Chronoxia:")
        print("1. Update Chronoxia + requirements (recommended)")
        print("2. Update Chronoxia")
...
def maintenance_menu():
    ...
    while True:
        print(INTRO)
        print("Maintenance:\n")
        print("1. Repair Chronoxia (discards code changes, keeps data intact)")
...
def run_Chronoxia(autorestart):
    ...
    if verify_requirements() is None:
        print("You don't have the requirements to start Chronoxia. "
              "Install them from the launcher.")
        if not INTERACTIVE_MODE:
            exit(1)

    cmd = (interpreter, "chronoxia.py")
    ...
    print("Chronoxia has been terminated. Exit code: %d" % code)
...
def main():
    ...
    while True:
        ...
        print("1. Run Chronoxia /w autorestart in case of issues")
        print("2. Run Chronoxia")
        print("3. Update")
...
if __name__ == '__main__':
    ...
    os.chdir(dirname)
    if not PYTHON_OK:
        print("Chronoxia needs Python 3.5 or superior. Install the required "
              "version.\nPress enter to continue.")
        if INTERACTIVE_MODE:
            wait()
        exit(1)
    if pip is None:
        print("Chronoxia cannot work without the pip module. Please make sure to "
