...
class General:
    ...
    async def rps(self, ctx, your_choice : RPSParser):
        ...
        chrono_choice = choice((RPS.rock, RPS.paper, RPS.scissors))
        cond = {
        ...
        if chrono_choice == player_choice:
            outcome = None # Tie
        else:
            outcome = cond[(player_choice, chrono_choice)]

        if outcome is True:
            await self.bot.say("{} You win {}!"
                               "".format(chrono_choice.value, author.mention))
