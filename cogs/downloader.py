...
REPO_CLONE = 0x2
REPO_SAME = 0x4
REPOS_LIST = "https://lsomers984.github.io/Chrono-Docs/chrono_cog_approved_repos/"

DISCLAIMER = ("You're about to add a 3rd party repository. The creator of Chronoxia"
...
class Downloader:
    ...
    async def _send_list(self, repo_name=None):
        ...
        Repositories list:
        "https://lsomers984.github.io/Chrono-Docs/chrono_cog_approved_repos/"""
        retlist = []
    ...
    def update_repo(self, name):
        ...
        try:
            ...
            # Make sure we don't git reset the Chrono folder on accident
